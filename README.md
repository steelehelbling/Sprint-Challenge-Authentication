...
The bcrypt hashing function allows us to build in password security by hashing many times

- [x] What does bcrypt do to slow down attackers?

It changes all data into a hash string that can’t be read unless you use the decoder and it makes all passwords safe
